...
class HomeController extends Controller
{
    ...
    {
        // Page d'accueil moderne EtapSup (design Diplomeo)
            ...
            return Property::with([
                ...
                ->map(function($property) {
                    return [
                        ...
                        'country' => $property->city?->country?->name ?? 'Non spécifié',
        ...
        // Pays avec établissements publiés
        ...
        $stats = [
            ...
            'totalStudents' => 2500, // Hardcodé MVP
