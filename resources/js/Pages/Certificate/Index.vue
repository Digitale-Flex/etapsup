...
const content = reactive({
    title: 'Obtenez votre Attestation de Logement en France : Facile, Rapide et Sans Tracas',
    description: 'Remplissez un formulaire en ligne, effectuez un paiement sécurisé et recevez votre attestation de logement directement par email. Un processus rapide et sans tracas.',
    options: [
        {
            title: 'Procédure Simplifiée',
            description:'Obtenez votre attestation en quelques minutes grâce à notre formulaire en ligne intuitif et facile à remplir'
        }, {
            title: 'Paiement Sécurisé',
            description:"Effectuez votre paiement en toute sécurité grâce à nos options de paiement protégées et cryptées. Votre tranquillité d'esprit est notre priorité."
        }, {
            title: 'Réception Rapide',
            description:"Recevez votre attestation de logement directement dans votre boîte email dès que votre paiement est confirmé. Pas d'attente, pas de stress."
        },{
            title: 'Assistance Dédiée',
            description:'Notre équipe de support est à votre disposition pour vous aider à chaque étape du processus. Contactez-nous pour toute question ou assistance'
        }
    ]
})
...
const testimonialSlides = [
    {
        ...
        name: 'Alexandre V.',
        description: "Je recommande vivement <b>MAREZA</b>, leurs équipes sont attentive et très professionnelle, merci à Alban qui m'a aidé dans mes démarches et qui m'a m'a offert un service unique et unique et personnalisé.",
    ...
    },
    {
        ...
        name: 'Brice B.',
        description: "Je profite de ce témoignage pour remercier toute l’équipe de <b>MAREZA</b> pour leur professionnalisme, gentillesse, investissement et rapidité. Sans eux, je serais sûrement encore en train de chercher un logement ! L’appartement où je suis est très bien et je m’y plais beaucoup.",
    ...
    },
    {
        ...
        name: 'Eric B.',
        description: "<b>MAREZA</b> m’a trouvé un logement transitoire et organisé, selon mes critères, Elles m’ont simplifié la vie : mon installation s’est faite sans stress.",
        position: 'Editor in Chief',
        rating: 4.5
    }
]
...
<template>
    <AppHead :title="content.title">
        <meta head-key="description" name="description" :content="content.description" />
    </AppHead>
    <section>
        <b-container>
            <b-row class="g-4">
                <b-col lg="4" class="position-relative">
                    ...
                    <img src="/images/front/3d-rendering-loft-luxury-living-room-with-bookshelf.jpg" class="rounded-3" alt="" />

                    <div class="d-grid">
                        <Link :href="route('certificate.option')" class="mt-2 btn btn-primary">Obtenir mon attestation</Link>
                    </div>

                    <figure
                        class="position-absolute me-lg-n5 mb-n3 bottom-0 end-0"
                    >
                        <svg
                            class="fill-info"
                            width="150px"
                            ...
                            style="enable-background: new 0 0 150 133.5"
                            xml:space="preserve"
                        >
                            <path
                ...
                <b-col lg="7" class="position-relative ms-auto">
                    <figure
                        class="position-absolute translate-middle ms-n4 z-index-9 d-none d-xl-block start-0 top-0 mt-8"
                    >
                        <svg
                            class="fill-orange"
                            width="153.6px"
                            ...
                            style="enable-background: new 0 0 153.6 71.4"
                            xml:space="preserve"
                        >
                            <path
                    ...
                    <div class="position-relative mb-5">
                        <img src="/images/front/pexels-imagestudio-1488315.jpg" class="rounded-3" alt="" />

                        <div
                            class="position-absolute ms-n3 ms-lg-n6 z-index-1 bottom-0 start-0 mb-2"
                        >
                            <div
                                class="bg-mode d-inline-block rounded-3 position-relative p-4 text-center shadow"
                            >
                                <span class="h3 text-primary mb-2">500+</span>
                                <h6 class="fw-normal">Attest... délivrées</h6>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="d-flex">
                                <figure>
                                    <svg
                                        width="50.1px"
                                        height="49.9px"
                                        viewBox="0 0 50.1 49.9"
                                        style="
                                            enable-background: new 0 0 50.1 49.9;
                                        "
                                        xml:space="preserve"
                                    >
                                        <path
                                ...
                                <div class="ms-3">
                                    <h5 class="mb-2">{{ content.options[0].title }}</h5>
                                    <p class="mb-0">
                            ...
                            <div class="d-flex">
                                <figure>
                                    <svg
                                        width="49.3px"
                                        height="56.1px"
                                        viewBox="0 0 49.3 56.1"
                                        style="
                                            enable-background: new 0 0 49.3 56.1;
                                        "
                                        xml:space="preserve"
                                    >
                                        <path
                                ...
                                <div class="ms-3">
                                    <h5 class="mb-2">{{ content.options[1].title }}</h5>
                                    <p class="mb-0">
                            ...
                            <div class="d-flex">
                                <figure>
                                    <svg
                                        width="50.5px"
                                        height="44.2px"
                                        viewBox="0 0 50.5 44.2"
                                        style="
                                            enable-background: new 0 0 50.5 44.2;
                                        "
                                        xml:space="preserve"
                                    >
                                        <path
                                ...
                                <div class="ms-3">
                                    <h5 class="mb-2">{{ content.options[2].title }}</h5>
                                    <p class="mb-0">
                                        {{ content.options[2].description }}
                                    </p>
                                </div>
                            </div>
                        </b-col>
                            ...
                            <div class="d-flex">
                                <figure>
                                    <svg
                                        ...
                                        viewBox="0 0 52 58.3"
                                        style="
                                            enable-background: new 0 0 52 58.3;
                                        "
                                        xml:space="preserve"
                                    >
                                        <path
                                ...
                                <div class="ms-3">
                                    <h5 class="mb-2">{{ content.options[3].title }}</h5>
                                    <p class="mb-0">
                                        {{ content.options[3].description }}
                                    </p>
                                </div>
                            </div>
                        </b-col>
    ...
    <section class="pt-0 pt-md-5">
        <b-container>
            <div
                ...
                :style="{
          backgroundImage: `url('/images/front/element/map.svg')`,
            ...
            >
                <div class="avatar position-absolute top-50 end-0 mt-5 me-7">
                    <img
                        ...
                        src="/images/front/avatar/09.jpg"
                        alt="avatar"
                    />
                </div>
                <div class="avatar avatar-lg position-absolute top-0 end-0 mt-5">
                    <img
                        ...
                        src="/images/front/avatar/05.jpg"
                        alt="avatar"
                    />
                </div>
                <div class="avatar position-absolute top-50 start-0 ms-5">
                    <img
                        class="avatar-img rounded-circle border border-2 border-light d-none d-md-block"
                        src="/images/front/avatar/04.jpg"
                        alt="avatar"
                    />
                </div>
                <div class="avatar avatar-sm position-absolute bottom-0 start-0 mb-5 ms-8">
                    <img
                        class="avatar-img rounded-circle border border-2 border-light d-none d-md-block"
                        src="/images/front/avatar/07.jpg"
                        alt="avatar"
                    />
                </div>
                <div class="avatar avatar-lg position-absolute top-0 start-0 mt-5">
                    <img
                        class="avatar-img rounded-circle border border-2 border-light d-none d-lg-block"
                        src="/images/front/avatar/06.jpg"
                        alt="avatar"
                    />
                </div>
                <b-row class="mb-5">
                    <b-col cols="12">
                        <h2>Quelques retours de clients </h2>
                    </b-col>
                </b-row>
                <b-row>
                        ...
                        <div class="tiny-slider dots-primary">
                            ...
                            >
                                <div v-for="(item, idx) in testimonialSlides" :key="idx">
                                    ...
                                    <p class="h5 fw-light mb-3">"<span v-html="item.description"/>"</p>
